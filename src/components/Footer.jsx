      ...
      <Container>
        <Row className='p-3'>
          <Col lg={3} className='p-2 '>
            ...
            <i class="fa-solid fa-people-carry-box mx-2 fs-4 text-white"></i>
            <Link style={{textDecoration:'none'}}><h4 className='fw-bold text-white'>JobHunt</h4></Link>
        ...
        <p className='text-center pb-5 text-white'>© 2024 Copyright- Job Hunt</p>
